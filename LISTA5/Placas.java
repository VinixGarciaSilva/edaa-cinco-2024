...
public class Placas {
    ...
    public static void main(String[] args) {
        ...
        int[] momentos = { 1860, 1440, 1521, 1040, 1225, 1370, 1579, 1901, 1515, 1770, 1620, 1095, 1263, 1105 };

        for (int placa : momentos) {
            int index = findIndex(placas, placa);
            if (index != -1) {
                System.out.println("Registro: " + LocalDate.now());
                System.out.println("Placa do veículo: " + placa);
                System.out.println("Momento (posição) em que trafegou na via: " + (index + 1));
                System.out.println();
            } else {
