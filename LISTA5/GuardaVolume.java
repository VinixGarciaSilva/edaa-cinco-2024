...
public class GuardaVolume {
    ...
    public static void main(String[] args) {
        ...
        int[] galaxias = { 285964, 199976, 323739 };

        for (int galaxia : galaxias) {
            int index = findIndex(guardaVolumes, galaxia);
            if (index != -1) {
                System.out.println("Registro: " + LocalDate.now());
                System.out.println("Guarda volume da galáxia: " + galaxia);
                System.out.println("Número do guarda volume: " + (index + 1));
                System.out.println();
            } else {
                System.out.println("Galáxia  " + galaxia + " não encontrada.");
            }
        }
    }
